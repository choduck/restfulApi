...
//ac171 메인 class 생성
ac171.prototype.onRun = function(req,res)
{
    ...
    try {
        ...
        KVQueryManager.sendProcessByName('ac171', (queryData)=> {
            ...
            block['noti_tp'] = res.noti_tp
            block['connect_key'] = req.body.connect_key
            ...
            tcpClient_.rcvMcaData(queryData,function(rcvData,client) {
                ...
                console.log('ac171 rcv Data ===========>',Utf8ArrayToStr(rcvData)); 
                ...
                if (rcvData)
                {
                    ...
                    KVQueryManager.onPreReceived(rcvData,function(data) {
                        ...
                        console.log('ac171 rcv Data ===========>', data); 
