...
function KVWebsocketIO(listener, isSSL)
{
	WebsocketIO.call(this, listener, isSSL);
...
afc.extendsClass(KVWebsocketIO, WebsocketIO);


KVWebsocketIO.prototype.startIO = function(address, port, isSSL)
{
	//super.startIO(address, port, isSSL);//20180327 이문수 주석처리 >>

	this.readBuf = new Uint8Array(4096 * 2);
    this.readSize = SZ_SIZE_HEADER;
    this.packetInx = 0;
	...
	WebsocketIO.prototype.startIO.call(this, address, port, isSSL);//20180327 이문수 >>
};

KVWebsocketIO.prototype.stopIO = function(isClosed)
{
	WebsocketIO.prototype.stopIO.call(this, isClosed);
	
	//20180327 이문수 주석처리 Close 호출된 상태에서 통신이 느려 뒤늦게 OnReceive가 호출되는 경우가 있다>>
	//this.readBuf = null;
	//this.chnBuf = null;
	//this.zipBuf = null;
	//this.encBuf = null;
...
//data is Uint8Array
KVWebsocketIO.prototype.sendData = function(data, callback)
{
...
KVWebsocketIO.prototype.onReceived = function(data)
{
...
KVWebsocketIO.prototype.setUnikeyAIR = function(unikeyAIR)
{
	this.unikeyAIR = unikeyAIR;
};

KVWebsocketIO.prototype.getUnikeyAIR = function()
{
	return this.unikeyAIR;
};

KVWebsocketIO.prototype.setUserSeed = function(userSeed)
{
	this.userSeed = userSeed;
};

KVWebsocketIO.prototype.uint8ArrayToArray = function(uint8Array)
{
	if(Array.from) return Array.from(uint8Array);
	else return Array.prototype.slice.call(uint8Array);
};

KVWebsocketIO.prototype.process_error = function(rv)
{
