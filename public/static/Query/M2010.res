BEGIN_FUNCTION_MAP
	...
	BEGIN_DATA_MAP
		...
		begin
			...
			접속서버IP주소 , conn_ip_addr    , conn_ip_addr    , char , 16; // NEXT필드-최초:9(16)
			목적서버IP주소 , obj_ip_addr     , obj_ip_addr     , char , 16; // NEXT필드-최초:9(16)
		...
		begin
			일자           , dt              , dt              , char ,  8;
			시간           , time            , time            , char ,  6;
			접속서버IP주소 , conn_ip_addr    , conn_ip_addr    , char , 16;
			목적서버IP주소 , obj_ip_addr     , obj_ip_addr     , char , 16;
