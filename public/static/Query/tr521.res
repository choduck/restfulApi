BEGIN_FUNCTION_MAP
	.Func,(tr521)거래내역조회,tr521,headtype=A;
	BEGIN_DATA_MAP
		tr521In,입력,input;
		begin
			계정ID			, user_id			, user_id			, char , 10;
			조회주문구분	 , qry_ord_tp		 , qry_ord_tp		 , char , 1;
			조회조건구분	 , qry_cond_tp		 , qry_cond_tp		 , char , 1;
			종목코드		 , symbol			 , symbol			 , char , 15;
			매수도구분		 , buy_sell_tp		 , buy_sell_tp		 , char , 1;
			자동매매구분	 , qry_auto_trd_tp   , qry_auto_trd_tp	 , char , 1;
			조회시작일자     , qry_st_dt         , qry_st_dt         , char	, 8;
			조회종료일자     , qry_en_dt         , qry_en_dt         , char	, 8;
			검색코인		 , trgt_coin		 , trgt_coin		 , char , 10;
		...
		begin
			...
			시스템메매구분      , sys_trd_tp       , sys_trd_tp      , char    , 1       ;  
