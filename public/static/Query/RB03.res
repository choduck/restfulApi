BEGIN_FUNCTION_MAP
    .Push, (RB03)주문체결통지자동주문, RB03, key=10, keycnt=4000, bufcnt=100, group=1;
    BEGIN_DATA_MAP
    InBlock,입력,input;
    begin
    ...
    Stop              , stop_prc         , stop_prc          , num,    40;
    OrderQuantity     , ordr_q           , ordr_q            , num,    40;
    OrderPrice        , ordr_prc         , ordr_prc          , num,    40;
    OrdrAmt          , ordr_amt         , ordr_amt          , num,    40;
    Distance          , distance         , distance          , num,    40;
    end
    END_DATA_MAP
END_FUNCTION_MAP
