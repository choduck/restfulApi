...
// 전문 수신 후 프로세스
QueryManager.prototype.queryProcess = function()
{
//##########################################	
...
QueryManager.prototype.sendProcessByName = function(queryName, menuNo, groupName, beforeInBlockBuffer, afterOutBlockData)
{
...
QueryManager.prototype.sendProcessWithReal = function(queryName, menuNo, groupName, beforeInBlockBuffer, afterOutBlockData, option, realCallback)
{
	...
	this.sendProcessByName(queryName, menuNo, groupName, 
