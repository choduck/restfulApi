...
AContainer.prototype.setTabKeyComponent = function()
{
	this.tabKey.setTabKeyComponent(this.view);
};

AContainer.prototype.open = function(url, parent, left, top, width, height, isPopup)
{
	//parent 가 지정 되어져 있지 않으면
	if(!parent) parent = theApp.rootContainer;
...
{
	//if(!this.element || !this.onClose()) return false;
