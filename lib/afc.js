...
afc.ClassName = {
    ...
    var t = global[e].CONTEXT;
    return t ? t.events.concat(AEvent.defEvents) : []
// }, afc.isAndroid = !1, afc.isIos = !1, afc.isTizen = !1, afc.isPC = !1, afc.isMobile = !1, afc.isSimulator = !1, afc.isChrome = !1, afc.isSystemWebview = !1, afc.isIE = !1, afc.isHybrid = !1, afc.isSamsungBrowser = !1, afc.andVer = 1e3, afc.iosVer = 1e3, afc.strAndVer = "", afc.strIosVer = "", afc.strIEVer = "", afc.strModuleName = "", afc.scrlWidth = 17, afc.OS = "", afc.DIV = "/", global.navigator.platform.indexOf("Win") > -1 ? (afc.OS = "WIN", afc.DIV = "\\") : global.navigator.platform.indexOf("Mac") > -1 ? (afc.OS = "MAC", afc.DIV = "/") : (afc.OS = "LNX", afc.DIV = "/"), afc.isDeviceOf = function (e) {
//     return navigator.userAgent.indexOf(e) > -1
    ...
    var t = "tel:" + e;
    afc.isAndroid ? AppManager.goUrl(t) : afc.isIos && (global.location = t)
